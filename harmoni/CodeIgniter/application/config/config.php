...
|
*/
$config['base_url'] = 'forfapeda.web.id/harmoni';
...
*/
$config['composer_autoload'] = active;
...
|
*/
$config['cache_query_string'] = active;
...
|
*/
$config['standardize_newlines'] = active;
