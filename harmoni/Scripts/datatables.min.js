...
(function(l) {
    ...
    function Bb(a, b, c, d, e, h) {
        ...
        for (; d !== e; )
            a.hasOwnProperty(d) && (f = g ? b(f, a[d], d, a) : a[d],
            g = !0,
            d += h);
        return f
    }
    ...
    function T(a, b, c, d) {
        ...
        if (k === q)
            return a.iDrawError != e && null === f && (da(a, 0, "Requested unknown parameter " + ("function" == typeof h.mData ? "{function}" : "'" + h.mData + "'") + " for row " + b + ", column " + c, 4),
            a.iDrawError = e),
            f;
        if ((k === g || null === k) && null !== f && d !== q)
            k = f;
    ...
    function ab(a, b, c, d) {
        var e = [], h = b.firstChild, g, f = 0, k, n = a.aoColumns, m = a._rowReadObject;
        d = d !== q ? d : m ? {} : [];
        var p = function(x, w) {
            if ("string" === typeof x) {
                var r = x.indexOf("@");
          ...
          , t = function(x) {
            if (c === q || c === f)
                g = n[f],
                k = x.innerHTML.trim(),
                g && g._bAttrSrc ? (ha(g.mData._)(d, k),
                p(g.mData.sort, x),
                p(g.mData.type, x),
                p(g.mData.filter, x)) : m ? (g._setter || (g._setter = ha(g.mData)),
                g._setter(d, k)) : d[f] = k;
            f++
        };
        if (h)
    ...
    function $a(a, b, c, d) {
        ...
        if (null === e.nTr) {
            ...
            for (f = a.aoColumns.length; m < f; m++) {
                ...
                g.push(e);
                if (k || !(!p.mRender && p.mData === m || l.isPlainObject(p.mData) && p.mData._ === m + ".display"))
    ...
    function ja(a, b) {
        ...
        if (-1 !== l.inArray(!1, c))
            ...
            var d = 0
              ...
              , n = a.aiDisplay;
            a.bDrawing = !0;
            f !== q && -1 !== f && (a._iDisplayStart = k ? f : f >= a.fnRecordsDisplay() ? 0 : f,
        ...
        for (var h = a.sDom.split(""), g, f, k, n, m, p, t = 0; t < h.length; t++) {
            ...
            if ("<" == f) {
                ...
                if ("'" == n || '"' == n) {
                    ...
                    k.className = n[1]) : "#" == m.charAt(0) ? k.id = m.substr(1, m.length - 1) : k.className = m;
                    t += p
                }
                e.append(k);
                e = l(k)
    ...
    function Oa(a, b, c) {
        ...
        a.fnServerData ? a.fnServerData.call(g, a.sAjaxSource, l.map(b, function(m, p) {
            ...
            url: h || a.sAjaxSource
        })) : "function" === typeof h ? a.jqXHR = h.call(g, b, f, a) : (a.jqXHR = l.ajax(l.extend(n, h)),
        h.data = k)
    }
    function Fb(a) {
        a.iDraw++;
    ...
    function Ob(a) {
        ...
        for (k = 0; k < c; k++) {
            ...
            m("mDataProp_" + k, n);
            d.bFilter && (m("sSearch_" + k, v.sSearch),
            ...
            if (!f._aFilterData) {
                ...
                for (d = b.length; n < d; n++) {
                    ...
                    if (h.bSearchable) {
                        ...
                        m = "";
                    m.indexOf && -1 !== m.indexOf("&") && (Qa.innerHTML = m,
    ...
    function Ha(a) {
        ...
        if (a.scrollBarVis !== fa && a.scrollBarVis !== q)
            ...
            h = w.outerWidth();
            "" === c ? (C.width = "100%",
            L && (w.find("tbody").height() > f.offsetHeight || "scroll" == m.css("overflow-y")) && (C.width = K(w.outerWidth() - b)),
            ...
            w.outerWidth() < h ? (la = f.scrollHeight > f.offsetHeight || "scroll" == m.css("overflow-y") ? h + b : h,
    ...
    function Ya(a) {
        ...
        for (v = 0; v < k.length; v++) {
            var w = c[k[v]];
            null !== w.sWidth && (w.sWidth = Yb(w.sWidthOrig, p),
            t = !0)
        }
        if (d || !t && !h && !e && f == oa(a) && f == n.length)
            ...
            for (v = 0; v < k.length; v++)
                ...
                w.sWidthOrig && h && l(n[v]).append(l("<div/>").css({
                    width: w.sWidthOrig,
                    margin: 0,
                    padding: 0,
                    border: 0,
            ...
            h && g ? f.width(g) : h ? (f.css("width", "auto"),
            f.removeAttr("width"),
            f.width() < p.clientWidth && m && f.width(p.clientWidth)) : e ? f.width(p.clientWidth) : m && f.width(m);
    ...
    function cc(a, b, c) {
        ...
        b = function(f) {
            if (f && f.time) {
                ...
                if (-1 === l.inArray(!1, k) && (k = a.iStateDuration,
                !(0 < k && f.time < +new Date - 1E3 * k || f.columns && h.length !== f.columns.length))) {
                    a.oLoadedState = l.extend(!0, {}, f);
                    f.start !== q && (a._iDisplayStart = f.start,
                    a.iInitDisplayStart = f.start);
                    f.length !== q && (a._iDisplayLength = f.length);
                    f.order !== q && (a.aaSorting = [],
    ...
    var u = function(a, b) {
        ...
        this.fnGetPosition = function(g) {
            ...
            return "TR" == k ? f.row(g).index() : "TD" == k || "TH" == k ? (g = f.cell(g).index(),
            [g.row, g.columnVisible, g.column]) : null
        }
        ;
        ...
        this.each(function() {
            ...
            if ("table" != this.nodeName.toLowerCase())
                ...
                t.addClass(C.sTable);
                r.iInitDisplayStart === q && (r.iInitDisplayStart = f.iDisplayStart,
                r._iDisplayStart = f.iDisplayStart);
                null !== f.iDeferLoading && (r.bDeferLoading = !0,
            ...
            for (h = f.length; m < h; m++) {
                ...
                if ("table" === b) {
                    ...
                    for (g = v.length; x < g; x++)
                        t = v[x],
                        t = "cell" === b ? c.call(p, f[m], t.row, t.column, m, x) : c.call(p, f[m], t, m, x, k),
                        t !== q && e.push(t)
                }
            }
            return e.length || d ? (a = new B(f,a ? e.concat.apply([], e) : e),
            b = a.selector,
            b.rows = n.rows,
            b.cols = n.cols,
            b.opts = n.opts,
    ...
    B.register = y = function(a, b) {
        if (Array.isArray(a))
            ...
            for (c = d.length; a < c; a++) {
                ...
                e.push(f));
                a === c - 1 ? (f.val = b,
                f.type = "function" === typeof b ? "function" : l.isPlainObject(b) ? "object" : "other") : e = h ? f.methodExt : f.propExt
            }
        }
    }
    ;
      ...
      , Va = function(a, b) {
        ...
        if ("current" == b)
            ...
            a = a.aoData.length; g < a; g++)
                "none" == h ? c.push(g) : (e = l.inArray(g, d),
        ...
        var e = []
          , h = function(g, f) {
            if (Array.isArray(g) || g instanceof l)
                ...
                g.nodeName && "tr" === g.nodeName.toLowerCase() ? e.push(g) : (k = l("<tr><td></td></tr>").addClass(f),
            ...
            if (null === w || w === q || r) {
                ...
                for (p = e.length; m < p; m++)
                    ...
                    t = 0; t < k; t++)
                        ...
                        r ? (x = d[f],
                        w(v, T(a, f, t), x.anCells ? x.anCells[t] : null) && n.push(v)) : n.push(v);
                return n
            }
    ...
    y("cells()", function(a, b, c) {
        ...
        var d = c ? {
            ...
            order: c.order,
            search: c.search
        } : {}, e = this.columns(b, d), h = this.rows(a, d), g, f, k, n;
    ...
    y("destroy()", function(a) {
        ...
        return this.iterator("table", function(b) {
            ...
            e != g.parentNode && (k.children("thead").detach(),
            k.append(g));
            f && e != f.parentNode && (k.children("tfoot").detach(),
            k.append(f));
            b.aaSorting = [];
            b.aaSortingFixed = [];
            Ra(b);
    ...
    l.extend(!0, u.ext.renderer, {
        pageButton: {
            _: function(a, b, c, d, e, h) {
                var g = a.oClasses, f = a.oLanguage.oPaginate, k = a.oLanguage.oAria.paginate || {}, n, m, p = 0, t = function(x, w) {
        ...
        header: {
            ...
            jqueryui: function(a, b, c, d) {
                ...
                l(a.nTable).on("order.dt.DT", function(e, h, g, f) {
                    a === h && (e = c.idx,
                    b.removeClass(d.sSortAsc + " " + d.sSortDesc).addClass("asc" == f[e] ? d.sSortAsc : "desc" == f[e] ? d.sSortDesc : c.sSortingClass),
                    b.find("span." + d.sSortIcon).removeClass(d.sSortJUIAsc + " " + d.sSortJUIDesc + " " + d.sSortJUI + " " + d.sSortJUIAscAllowed + " " + d.sSortJUIDescAllowed).addClass("asc" == f[e] ? d.sSortJUIAsc : "desc" == f[e] ? d.sSortJUIDesc : c.sSortingClassJUI))
                })
            }
        }
    });
