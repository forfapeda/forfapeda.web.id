!function(t, e) {
    ...
    var A, P = function(t) {
        ...
        var e;
        if ((e = I()) && (e.parentNode.removeChild(e),
        O([document.documentElement, document.body], [x["no-backdrop"], x["toast-shown"], x["has-column"]])),
        nt())
        ...
        t.html ? (at(t.html, e),
        V(e, "block")) : t.text ? (e.textContent = t.text,
        V(e, "block")) : q(e),
        function(e) {
            for (var t, n = z(), o = ["input", "file", "range", "select", "radio", "checkbox", "textarea"], i = function(t) {
                ...
                if (t = S(n, o[r])) {
                    ...
                    for (var l in e.inputAttributes)
                        "range" === o[r] && "placeholder" === l || t.setAttribute(l, e.inputAttributes[l])
                }
                s.className = a,
            ...
            case "url":
                t = T(n, x.input),
                "string" == typeof e.inputValue || "number" == typeof e.inputValue ? t.value = e.inputValue : B(e.inputValue) || C('Unexpected type of inputValue! Expected "string", "number" or "Promise", got "'.concat(w(e.inputValue), '"')),
                i(t),
                t.type = e.input,
                V(t);
                break;
        ...
        function(t) {
            ...
            t.type)
                if (dt(),
                -1 !== Object.keys(g).indexOf(t.type)) {
                    ...
                    k('Unknown type! Expected "success", "error", "warning", "info" or "question", got "'.concat(t.type, '"'))
        }(t),
        function(t) {
            var e = W();
            if (!t.imageUrl)
        ...
        n.className = x.popup,
        e.toast ? (E([document.documentElement, document.body], x["toast-shown"]),
        E(n, x.toast)) : E(n, x.modal),
        ...
        function(t) {
            var e = I();
            if (e) {
                if ("string" == typeof t.backdrop ? e.style.background = t.backdrop : t.backdrop || E([document.documentElement, document.body], x["no-backdrop"]),
                !t.backdrop && t.allowOutsideClick && C('"allowOutsideClick" parameter requires `backdrop` parameter to be set to `true`'),
                t.position in x ? E(e, x[t.position]) : (C('The "position" parameter is not valid, defaulting to "center"'),
                E(e, x.center)),
        ...
        function(t) {
            var e = Y()
              , n = Z()
              , o = Q();
            if (t.showConfirmButton || t.showCancelButton ? V(e) : q(e),
      ...
      , Bt = Object.freeze({
        ...
        queue: function(t) {
            ...
            return new Promise(function(i) {
                !function e(n, o) {
                    n < gt.length ? (document.body.setAttribute("data-swal2-queue-step", n),
            ...
            var s = function() {
                et() ? Tt(a) : (new Promise(function(t) {
                    ...
                    vt.restoreFocusTimeout = setTimeout(function() {
                        vt.previousActiveElement && vt.previousActiveElement.focus ? (vt.previousActiveElement.focus(),
                        vt.previousActiveElement = null) : document.body && document.body.focus(),
                        t()
                    }, 100),
                ...
                tt() && (null !== v.previousBodyPadding && (document.body.style.paddingRight = v.previousBodyPadding + "px",
    ...
    var Ht = function(t) {
        ...
        t.animation ? (E(n, x.show),
        E(e, x.fade),
        O(n, x.hide)) : O(n, x.fade),
        V(n),
        ...
        "undefined" != typeof window && Pt() && (Lt(),
        window.addEventListener("resize", Lt)),
        p(document.body.children).forEach(function(t) {
            t === I() || function(t, e) {
                if ("function" == typeof t.contains)
                    return t.contains(e)
            }(t, I()) || (t.hasAttribute("aria-hidden") && t.setAttribute("data-previous-aria-hidden", t.getAttribute("aria-hidden")),
    ...
    var Rt, Nt = Object.freeze({
        ...
        enableConfirmButton: function() {
            n("Swal.disableConfirmButton()", "Swal.getConfirmButton().removeAttribute('disabled')"),
            Mt(this, ["confirmButton"], !1)
        },
        disableConfirmButton: function() {
            n("Swal.enableConfirmButton()", "Swal.getConfirmButton().setAttribute('disabled', '')"),
        ...
        getProgressSteps: function() {
            return n("Swal.getProgressSteps()", "const swalInstance = Swal.fire({progressSteps: ['1', '2', '3']}); const progressSteps = swalInstance.params.progressSteps"),
        ...
        _main: function(t) {
            ...
            !function(t) {
                for (var e in t)
                    ...
                    t.toast && -1 !== wt.indexOf(e) && C('The parameter "'.concat(e, '" is incompatible with toasts')),
                    kt(e) && n(e, kt(e))
            }(t);
            var f = s({}, bt, t);
            !function(e) {
            ...
            return new Promise(function(t) {
                ...
                f.timer && (vt.timeout = new qt(function() {
                    s("timer"),
                    delete vt.timeout
                }
                ,f.timer)),
                f.input && setTimeout(function() {
                    var t = p.getInput();
                    t && P(t)
                }, 0);
                for (var c = function(e) {
                    f.showLoaderOnConfirm && g.showLoading(),
                    f.preConfirm ? (p.resetValidationMessage(),
                    ...
                    case "click":
                        if (i)
                            ...
                            f.input) {
                                ...
                                f.inputValidator ? (p.disableInput(),
                                Promise.resolve().then(function() {
                                ...
                                })) : p.getInput().checkValidity() ? c(a) : (p.enableButtons(),
                ...
                }, o = m.popup.querySelectorAll("button"), i = 0; i < o.length; i++)
                    o[i].onclick = e,
                    o[i].onmouseover = e,
                    o[i].onmouseout = e,
                    o[i].onmousedown = e;
                ...
                f.toast)
                    ...
                    m.container.onmousedown = function() {
                        m.popup.onmouseup = function(t) {
                            ...
                            (t.target === m.popup || m.popup.contains(t.target)) && (r = !0)
                        }
                    }
                    ,
                ...
                vt.keydownHandlerAdded = !1),
                f.toast || (vt.keydownHandler = function(t) {
                    return function(t, e) {
                        ...
                        "Enter" !== t.key || t.isComposing)
                            if ("Tab" === t.key) {
                                ...
                                -1 !== ["ArrowLeft", "ArrowRight", "ArrowUp", "ArrowDown", "Left", "Right", "Up", "Down"].indexOf(t.key) ? document.activeElement === m.confirmButton && H(m.cancelButton) ? m.cancelButton.focus() : document.activeElement === m.cancelButton && H(m.confirmButton) && m.confirmButton.focus() : "Escape" !== t.key && "Esc" !== t.key || !0 !== h(e.allowEscapeKey) || (t.preventDefault(),
                ...
                "select" === f.input || "radio" === f.input) {
                    ...
                    B(f.inputOptions) ? (g.showLoading(),
                    ...
                    g.showLoading(),
                    q(d),
                    f.inputValue.then(function(t) {
                        d.value = "number" === f.input ? parseFloat(t) || 0 : t + "",
                        V(d),
                        d.focus(),
                        p.hideLoading()
                    }).catch(function(t) {
                ...
                Ht(f),
                f.toast || (h(f.allowEnterKey) ? f.focusCancel && H(m.cancelButton) ? m.cancelButton.focus() : f.focusConfirm && H(m.confirmButton) ? m.confirmButton.focus() : a(-1, 1) : document.activeElement && "function" == typeof document.activeElement.blur && document.activeElement.blur()),
    ...
    Object.keys(Nt).forEach(function(e) {
        Dt[e] = function() {
            var t;
            if (Rt)
                return (t = Rt)[e].apply(t, arguments)
        }
    }),
    Dt.DismissReason = t,
    Dt.version = "8.8.0";
