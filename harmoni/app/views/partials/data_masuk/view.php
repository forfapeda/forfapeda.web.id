...
$can_add = ACL::is_allowed("data_masuk/add");
$can_edit = ACL::is_allowed("data_masuk/edit");
$can_view = ACL::is_allowed("data_masuk/view");
$can_delete = ACL::is_allowed("data_masuk/delete");
?>
<?php
...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="view"  data-display-type="table" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">View  Data Masuk</h4>
                </div>
            </div>
        </div>
    </div>
