    ...
    d.fn.tableExport = function(k) {
        ...
        function R(b) {
            ...
            d(b).find("thead").first().find("th").each(function(b, c) {
                ...
                "undefined" !== typeof c.parentNode.rowIndex && q !== c.parentNode.rowIndex && (q = c.parentNode.rowIndex,
                e = f = 0);
                var h = J(c);
                for (e += h ? h : 1; f < e; )
                    a[f] = b ? d(c).attr("data-field") : f.toString(),
                    f++
            });
            return a
        }
        function I(b) {
            ...
            e && "none" !== f && "always" !== f && (b = d(b[0].parentNode),
        ...
        function E(b, c, e, q, f) {
            if ("function" === typeof f) {
                ...
                if (!1 === h && (0 === a.ignoreRow.length || -1 === d.inArray(e, a.ignoreRow) && -1 === d.inArray(e - q, a.ignoreRow)) && I(d(b))) {
                    b = v(d(b), c);
                    var n = b.length
                      , l = 0
                      , u = 0;
                    ...
                    d.each(G, function() {
                        if (e >= this.s.r && e <= this.e.r && l >= this.s.c && l <= this.e.c)
                            for (ea = 0; ea <= this.e.c - this.s.c; ++ea)
                                f(null, e, l++)
                    })
                }
            }
        ...
        function ua(b, a, e, d) {
            if ("undefined" !== typeof d.images && (e = d.images[e],
            "undefined" !== typeof e)) {
                ...
                var c = b.width / b.height
                  ...
                  , u = 19.049976 / 25.4
                  , g = 0;
                h <= c ? (l = Math.min(b.height, a.height),
                q = a.width * l / a.height) : h > c && (q = Math.min(b.width, a.width),
                l = a.height * q / a.width);
                q *= u;
                l *= u;
        ...
        function wa(b, a, e) {
            ...
            if (0 <= c) {
                for (var f = b.width, d = b.textPos.x, n = a.table.columns.indexOf(a.column), l = 1; l < c; l++)
                    f += a.table.columns[n + l].width;
        ...
        function xa(b, a, e) {
            ...
            d(b).attr("data-tableexport-canvas", a),
            e.images[a] = {
        ...
        function Ka(b, a) {
                ...
                if (b.url)
                    if (b.src) {
                        ...
                        c.onerror = c.onload = function() {
                            if (c.complete && (0 === c.src.indexOf("data:image/") && (c.width = b.width || c.width || 0,
                            c.height = b.height || c.height || 0),
                            c.width + c.height)) {
            ...
            if ("undefined" !== typeof b.images)
                for (var h in b.images)
                    b.images.hasOwnProperty(h) && c(b.images[h]);
            (b = f) || (a(q),
            b = void 0);
            return b
        }
                ...
                if (c.length) {
                    ...
                    for (var n = !1, l = !1; c; ) {
                        ...
                        if (g = e.doc.getStringUnitWidth(u) * e.doc.internal.getFontSize()) {
                            "linebreak" === b.styles.overflow && q > b.textPos.x && q + g > b.textPos.x + b.width && (0 <= ".,!%*;:=-".indexOf(u.charAt(0)) && (k = u.charAt(0),
                            g = e.doc.getStringUnitWidth(k) * e.doc.internal.getFontSize(),
                            q + g <= b.textPos.x + b.width && (e.doc.autoTableText(k, q, f, h),
                            u = u.substring(1, u.length)),
                            g = e.doc.getStringUnitWidth(u) * e.doc.internal.getFontSize()),
                            q = b.textPos.x,
                            f += e.doc.internal.getFontSize());
                            if ("visible" !== b.styles.overflow)
                                for (; u.length && q + g > b.textPos.x + b.width; )
                        ...
                        if (n || l)
                            d(c).is("b") ? n = !1 : d(c).is("i") && (l = !1),
                            e.doc.setFontType(n || l ? n ? "bold" : "italic" : "normal");
                        c = c.nextSibling
                    }
                    b.textPos.x = q;
                    b.textPos.y = f
                } else
                    e.doc.autoTableText(b.text, b.textPos.x, b.textPos.y, h)
            }
        }
        function W(b, a, e) {
        ...
        function D(b, c, e, q) {
            ...
            if (null !== b) {
                ...
                if (n[0].hasAttribute("data-tableexport-canvas"))
                    var l = "";
                else if (n[0].hasAttribute("data-tableexport-value"))
                    l = (l = n.attr("data-tableexport-value")) ? l + "" : "",
                    n.data("teUserDefText", 1);
                else if (l = n.html(),
                "function" === typeof a.onCellHtmlData)
                    l = a.onCellHtmlData(n, c, e, l),
                    n.data("teUserDefText", 1);
                else if ("" !== l) {
                    b = d.parseHTML(l);
                    var g = 0
                    ...
                    d.each(b, function() {
                        if (d(this).is("input"))
                            l += n.find("input").eq(g++).val();
                        else if (d(this).is("select"))
                            l += n.find("select option:selected").eq(k++).text();
                        else if (d(this).is("br"))
                            l += "<br>";
                        else {
                            if ("undefined" === typeof d(this).html())
                                l += d(this).text();
                            else if (void 0 === jQuery().bootstrapTable || !1 === d(this).hasClass("fht-cell") && !1 === d(this).hasClass("filterControl") && 0 === n.parents(".detail-view").length)
                                l += d(this).html();
                            if (d(this).is("a")) {
                    ...
                    if ("" !== n.attr("data-tableexport-cellformat")) {
                        ...
                        if ("json" === a.type || "excel" === a.type && "xmlss" === a.mso.fileFormat || !1 === a.numbers.output)
                            ...
                            !1 !== b) {
                                ...
                                h = "number";
                                f = (0 > b ? "-" : "") + (a.numbers.output.thousandsSeparator ? (t ? p[0].substr(0, t) + a.numbers.output.thousandsSeparator : "") + p[0].substr(t).replace(/(\d{3})(?=\d)/g, "$1" + a.numbers.output.thousandsSeparator) : p[0]) + (p[1].length ? a.numbers.output.decimalMark + p[1] : "")
                            }
                    } else
                        f = l;
                !0 === a.escape && (f = escape(f));
                "function" === typeof a.onCellData && (f = a.onCellData(n, c, e, f, h),
                n.data("teUserDefText", 1))
            }
            void 0 !== q && (q.type = h);
            return f
        ...
        function M(a, c) {
            try {
                return window.getComputedStyle ? (c = c.replace(/([a-z])([A-Z])/, Na),
                window.getComputedStyle(a, null).getPropertyValue(c)) : a.currentStyle ? a.currentStyle[c] : a.style[c]
            } catch (e) {}
            return ""
        }
        function ha(a, c, e) {
        ...
        function Oa(a) {
            for (var b = new ArrayBuffer(a.length), e = new Uint8Array(b), d = 0; d !== a.length; ++d)
        ...
        function oa(a) {
            var b = a.c
              , e = "";
            for (++b; b; b = Math.floor((b - 1) / 26))
                e = String.fromCharCode((b - 1) % 26 + 65) + e;
            return e + ("" + (a.r + 1))
        }
        function pa(a, c) {
        ...
        function N(b, c, d, q, f, h) {
            ...
            if (e)
                try {
                    ...
                    ka(c, "data:" + d + (q.length ? ";charset=" + q : "") + (f.length ? ";" + f : "") + ",", h ? "\ufeff" + b : b)
                }
        }
        function ka(b, c, d) {
            ...
            if (!1 !== b && window.navigator.msSaveOrOpenBlob)
                ...
                if (f) {
                    ...
                    "object" === typeof d ? (window.URL = window.URL || window.webkitURL,
                    e = [],
                    e.push(d),
                    h = window.URL.createObjectURL(new Blob(e,{
                        type: c
                    })),
                    f.href = h) : 0 <= c.toLowerCase().indexOf("base64,") ? f.href = c + L(d) : f.href = c + encodeURIComponent(d);
                    document.body.appendChild(f);
                    if (document.createEvent)
                        null === ia && (ia = document.createEvent("MouseEvents")),
                        ia.initEvent("click", !0, !1),
                        f.dispatchEvent(ia);
                    else if (document.createEventObject)
                        f.fireEvent("onclick");
                    else if ("function" === typeof f.onclick)
                        f.onclick();
                    setTimeout(function() {
                        h && window.URL.revokeObjectURL(h);
                        document.body.removeChild(f);
                        if ("function" === typeof a.onAfterSaveToFile)
                            a.onAfterSaveToFile(d, b)
                    }, 100)
                }
            }
        }
        function L(a) {
            ...
            if ("string" === typeof a) {
                ...
                for (b = 0; b < a.length; b++) {
                    ...
                    128 > h ? f += String.fromCharCode(h) : (127 < h && 2048 > h ? f += String.fromCharCode(h >> 6 | 192) : (f += String.fromCharCode(h >> 12 | 224),
            ...
            for (; q < a.length; ) {
                ...
                d = d + "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(h) + "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(n) + "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(l) + "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(g)
            }
            return d
        }
        var a = {
        ...
        S = R(B);
        if ("function" === typeof a.onTableExportBegin)
            a.onTableExportBegin();
        if ("csv" === a.type || "tsv" === a.type || "txt" === a.type) {
            ...
            var qa = function(b, c, e) {
                b.each(function() {
                    t = "";
                    E(this, c, p, e + b.length, function(b, c, d) {
                        var e = t
                          , f = "";
                        if (null !== b)
                            if (b = D(b, c, d),
                            ...
                            "tsv" === a.type)
                                ...
                                f = a.csvEnclosure + b.toLocaleString() + a.csvEnclosure;
                            else if (f = Ba(c),
                            f = W(f, a.csvEnclosure, a.csvEnclosure + a.csvEnclosure),
                            0 <= f.indexOf(a.csvSeparator) || /[\r\n ]/g.test(f))
                                f = a.csvEnclosure + f + a.csvEnclosure;
            ...
            d(w).each(function() {
                ...
                0 < t.length && "<column-1></column-1>" !== t && (Q += '<row id="' + Fa + '">' + t + "</row>",
                Fa++);
                p++
            });
            Q += "</data></tabledata>";
            ...
            d(B).filter(function() {
                ...
                !1 === a.exportHiddenCells && (K = c.find("tr, th, td").filter(":hidden"),
                V = 0 < K.length);
                p = 0;
                S = R(this);
                H = "<Table>\r";
            ...
            k = {};
            z = {};
            for (var m, aa, Y = 0, ea = F.length; Y < ea; Y++)
                m = F[Y],
                aa = k[m],
                aa = k[m] = null == aa ? 1 : aa + 1,
                2 === aa && (F[z[m]] = F[z[m]].substring(0, 29) + "-1"),
                1 < k[m] ? F[Y] = F[Y].substring(0, 29) + "-" + k[m] : z[m] = Y;
            ...
            for (z = 0; z < sa.length; z++)
                k += '<Worksheet ss:Name="' + F[z] + '" ss:RightToLeft="' + (a.mso.rtl ? "1" : "0") + '">\r' + sa[z],
                k = a.mso.rtl ? k + '<WorksheetOptions xmlns="urn:schemas-microsoft-com:office:excel">\r<DisplayRightToLeft/>\r</WorksheetOptions>\r' : k + '<WorksheetOptions xmlns="urn:schemas-microsoft-com:office:excel"/>\r',
                k += "</Worksheet>\r";
            k += "</Workbook>\r";
            if ("string" === a.outputMode)
                return k;
            ...
            d(B).filter(function() {
                ...
                for (var b = d(this), c = {}, e = this.getElementsByTagName("tr"), g = {
                    ...
                    if (k = e[l],
                    m = !1,
                    "function" === typeof a.onIgnoreRow && (m = a.onIgnoreRow(d(k), l)),
                    !0 !== m && (0 === a.ignoreRow.length || -1 === d.inArray(l, a.ignoreRow) && -1 === d.inArray(l - e.length, a.ignoreRow)) && !1 !== I(d(k))) {
                        var y = k.children
                          , B = 0;
                        ...
                        for (k = m = 0; k < y.length; ++k)
                            ...
                            t = +J(r) || 1,
                            h = k + z,
                            !ta(d(r), B, h + (h < m ? m - h : 0))) {
                                z += t - 1;
                                for (h = 0; h < f.length; ++h) {
                                    var v = f[h];
                                    v.s.c == m && v.s.r <= u && u <= v.e.r && (m = v.e.c + 1,
                                    h = -1)
                                }
                                (0 < (p = +T(r)) || 1 < t) && f.push({
                                    s: {
                                ...
                                if ("" !== (d(r).attr("data-tableexport-cellformat") || "")) {
                                    ...
                                    0 === x && "function" === typeof a.mso.xslx.formatId.numbers && (x = a.mso.xslx.formatId.numbers(d(r), l, k + z));
                                    0 === x && "function" === typeof a.mso.xslx.formatId.date && (x = a.mso.xslx.formatId.date(d(r), l, k + z));
                                    if (49 === x || "@" === x)
                                        A = "s";
                                    else if ("number" === C.type || 0 < x && 14 > x || 36 < x && 41 > x || 48 === x)
                                        A = "n";
                                    else if ("date" === C.type || 13 < x && 37 > x || 44 < x && 48 > x || 56 === x)
                                        A = "d"
                                } else
                                    A = "s";
                                if (null != h)
                                    if (0 === h.length)
                                        ...
                                        if ("s" === A)
                                            d(r).find("a").length && (h = "href" !== a.htmlHyperlink ? h : "",
                                            v = {
                                            ...
                                            if (r = Da(h, a.numbers.output),
                                            0 === x && "function" !== typeof a.mso.xslx.formatId.numbers && (x = a.mso.xslx.formatId.numbers),
                                            isFinite(r) || isFinite(h))
                                                v = {
                                                    t: "n",
                                                    v: isFinite(r) ? r : h,
                                                    z: "string" === typeof x ? x : x in w ? w[x] : "0.00"
                                                }
                                        } else if (!1 !== (r = La(h)) || "d" === A)
                                            0 === x && "function" !== typeof a.mso.xslx.formatId.date && (x = a.mso.xslx.formatId.date),
                                            v = {
                                                t: "d",
                                                v: !1 !== r ? r : h,
                ...
                g.e.r = u - 1;
                c["!ref"] = pa(g);
                1E7 <= u && (c["!fullref"] = pa((g.e.r = e.length - l + u - 1,
                g)));
                e = "";
            ...
            d(B).filter(function() {
                ...
                var b = d(this);
                "" === ca && (ca = a.mso.worksheetName || b.find("caption").text() || "Table",
                ca = d.trim(ca.replace(/[\\\/[\]*:?'"]/g, "").substring(0, 31)));
                !1 === a.exportHiddenCells && (K = b.find("tr, th, td").filter(":hidden"),
                V = 0 < K.length);
                p = 0;
                G = [];
                S = R(this);
                    ...
                    E(this, "th,td", p, r.length, function(d, c, f) {
                        if (null !== d) {
                            ...
                            if (a.mso.styles.length) {
                                var n = document.defaultView.getComputedStyle(d, null), l = document.defaultView.getComputedStyle(b[0], null), g;
                                for (g in a.mso.styles) {
                                    var k = n[a.mso.styles[g]];
                                    "" === k && (k = l[a.mso.styles[g]]);
                                    "" !== k && "0px none rgb(0, 0, 0)" !== k && "rgba(0, 0, 0, 0)" !== k && (e += "" === e ? 'style="' : ";",
                                    e += a.mso.styles[g] + ":" + k)
                                }
                            }
                            "" !== e && (t += " " + e + '"');
                ...
                d(w).each(function() {
                    var b = d(this);
                    t = "";
                    E(this, "td,th", p, r.length + w.length, function(c, g, f) {
                        if (null !== c) {
                            var e = D(c, g, f)
                              , n = ""
                            ...
                            if (a.mso.styles.length) {
                                ...
                                for (var k in a.mso.styles)
                                    l = g[a.mso.styles[k]],
                                    "" === l && (l = f[a.mso.styles[k]]),
                                    "" !== l && "0px none rgb(0, 0, 0)" !== l && "rgba(0, 0, 0, 0)" !== l && (n += "" === n ? 'style="' : ";",
                                    n += a.mso.styles[k] + ":" + l)
                            }
                            t += "<td";
                            "" !== n && (t += " " + n + '"');
            ...
            html2canvas(d(B)[0]).then(function(b) {
                b = b.toDataURL();
                for (var c = atob(b.substring(22)), d = new ArrayBuffer(c.length), g = new Uint8Array(d), f = 0; f < c.length; f++)
                    g[f] = c.charCodeAt(f);
                if ("string" === a.outputMode)
                    return c;
                if ("base64" === a.outputMode)
            ...
            if (!0 === a.pdfmake.enabled) {
                ...
                d(B).filter(function() {
                    ...
                    r = y(b);
                    for (var f = g(r, "th,td", r.length), h = c.length; h < f; h++)
                        c.push("*");
                    w = C(b);
                    f = g(w, "td", r.length + w.length);
                    for (h = c.length; h < f; h++)
                        c.push("*");
                    U.content.push({
                        table: {
                        ...
                        layout: {
                            ...
                            fillColor: function(b, c, d) {
                                return 0 === b % 2 ? a.pdfmake.docDefinition.styles.alternateRow.fillColor : null
                            }
                        },
                ...
                pdfMake.vfs.hasOwnProperty("Mirza-Regular.ttf") ? (U.defaultStyle.font = "Mirza",
                ...
                })) : pdfMake.vfs.hasOwnProperty("gbsn00lp.ttf") ? (U.defaultStyle.font = "gbsn00lp",
                d.extend(!0, pdfMake.fonts, {
                    gbsn00lp: {
                        normal: "gbsn00lp.ttf",
                        bold: "gbsn00lp.ttf",
                ...
                })) : pdfMake.vfs.hasOwnProperty("ZCOOLXiaoWei-Regular.ttf") && (U.defaultStyle.font = "ZCOOLXiaoWei",
                d.extend(!0, pdfMake.fonts, {
                    ZCOOLXiaoWei: {
                ...
                pdfMake.createPdf(U).getBuffer(function(b) {
                ...
                if ("string" === typeof a.jspdf.format && "bestfit" === a.jspdf.format.toLowerCase()) {
                    ...
                    d(B).each(function() {
                        if (I(d(this))) {
                            var a = ha(d(this).get(0), "width", "pt");
                            if (a > Ia) {
                                a > O.a0[0] && (ja = "a0",
                                da = "l");
                                for (var c in O)
                                    O.hasOwnProperty(c) && O[c][1] > a && (ja = c,
                                    da = "l",
                                    O[c][0] > a && (da = "p"));
                                Ia = a
                            }
                ...
                if (null == g.doc && (g.doc = new jsPDF(a.jspdf.orientation,a.jspdf.unit,a.jspdf.format),
                g.wScaleFactor = 1,
                g.hScaleFactor = 1,
                ...
                "undefined" !== typeof g.images && (d(B).filter(function() {
                    ...
                    var b = 0;
                    G = [];
                    !1 === a.exportHiddenCells && (K = d(this).find("tr, th, td").filter(":hidden"),
                    V = 0 < K.length);
                    r = y(d(this));
                    w = C(d(this));
                    d(w).each(function() {
                ...
                Ka(g, function() {
                    d(B).filter(function() {
                        ...
                        g.rows = [];
                        g.teCells = {};
                        if ("function" === typeof g.onTable && !1 === g.onTable(d(this), a))
                            return !0;
                        ...
                        "function" !== typeof c.createdHeaderCell && (c.createdHeaderCell = function(a, b) {
                            ...
                            if ("undefined" !== typeof g.columns[b.column.dataKey]) {
                                ...
                                "undefined" !== typeof e.style && !0 !== e.style.hidden && ("inherit" === c.headerStyles.halign && (a.styles.halign = e.style.align),
                                "inherit" === c.styles.fillColor && (a.styles.fillColor = e.style.bcolor),
                                "inherit" === c.styles.textColor && (a.styles.textColor = e.style.color),
                        ...
                        "function" !== typeof c.createdCell && (c.createdCell = function(a, b) {
                            ...
                            "undefined" !== typeof b && "undefined" !== typeof b.style && !0 !== b.style.hidden && ("inherit" === c.styles.halign && (a.styles.halign = b.style.align),
                        ...
                        "function" !== typeof c.drawCell && (c.drawCell = function(a, b) {
                            ...
                            if (!0 !== ("undefined" !== typeof c && c.isCanvas))
                                wa(a, b, c) && (g.doc.rect(a.x, a.y, a.width, a.height, a.styles.fillStyle),
                                "undefined" === typeof c || "undefined" !== typeof c.hasUserDefText && !0 === c.hasUserDefText || "undefined" === typeof c.elements || !c.elements.length ? Aa(a, {}, g) : (b = a.height / c.rect.height,
                                b > g.hScaleFactor && (g.hScaleFactor = b),
                                g.wScaleFactor = a.width / c.rect.width,
                                b = a.textPos.y,
                                za(a, c.elements, g),
                                a.textPos.y = b,
                                Aa(a, c.elements, g)));
                        ...
                        d(w).each(function() {
                            var a = [];
                            b = 0;
                            E(this, "td,th", p, r.length + w.length, function(c, e, f) {
                                ...
                                "undefined" !== typeof d(c).data("teUserDefText") && (h.hasUserDefText = !0)) : (h = d.extend(!0, {}, g.teCells[k + ":" + (b - 1)]),
                                h.colspan = -1);
                                g.teCells[k + ":" + b++] = h
                            });
                            a.length && (g.rows.push(a),
                            k++);
                            p++
                        });
                        if ("function" === typeof g.onBeforeAutotable)
                            g.onBeforeAutotable(d(this), g.columns, g.rows, c);
                        g.doc.autoTable(g.columns, g.rows, c);
                        if ("function" === typeof g.onAfterAutotable)
                            g.onAfterAutotable(d(this), c);
        ...
        if ("function" === typeof a.onTableExportEnd)
            a.onTableExportEnd();
        return this
    }
}
