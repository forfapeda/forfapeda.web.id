(function(i) {
    ...
    function n(a, c, d) {
        ...
        d && (d.attr && i(b).attr(d.attr),
        d.children && i.each(d.children, function(a, c) {
            b.appendChild(c)
        }),
    ...
    function I(a, c) {
        ...
        for (var e = 0, f = a.body.length; e < f && !(b = a.body[e][c].toString(),
        -1 !== b.indexOf("\n") ? (b = b.split("\n"),
        b.sort(function(a, b) {
    ...
    var u = function(a, c) {
      ...
      , F = function(a, c) {
        for (var d = E(c), b = a.buttons.exportData(c.exportOptions), e = c.fieldBoundary, f = c.fieldSeparator, i = RegExp(e, "g"), m = c.escapeChar !== p ? c.escapeChar : "\\", h = function(a) {
            ...
            return b
        }, g = c.header ? h(b.header) + d : "", k = c.footer && b.footer ? d + h(b.footer) : "", w = [], x = 0, j = b.body.length; x < j; x++)
            w.push(h(b.body[x]));
        return {
            str: g + w.join(d) + k,
            rows: w.length
    ...
    l.ext.buttons.csvHtml5 = {
        ...
        action: function(a, c, d, b) {
            ...
            !1 !== c ? (c || (c = k.characterSet || k.charset),
            c && (c = ";charset=" + c)) : c = "";
            b.bom && (a = "﻿" + a);
            o(new Blob([a],{
                type: "text/csv" + c
    ...
    l.ext.buttons.excelHtml5 = {
        ...
        action: function(a, c, d, b) {
            ...
            b.header && (d(c.header, e),
            i("row c", f).attr("s", "2"));
            for (var j = 0, l = c.body.length; j < l; j++)
                d(c.body[j], e);
            b.footer && c.footer && (d(c.footer, e),
            i("row:last c", f).attr("s", "2"));
            d = n(f, "cols");
            i("worksheet", f).prepend(d);
            j = 0;
            for (l = c.header.length; j < l; j++)
                d.appendChild(n(f, "col", {
                    attr: {
                        min: j + 1,
                        max: j + 1,
                        width: I(c, j),
