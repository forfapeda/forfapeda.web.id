    ...
    var d = {
        print: function(t) {
            ...
            a(t.doc).ready(function() {
                e.focus(),
                e.print(),
                c.mode == o && c.popClose && setTimeout(function() {
                    e.close()
                }, 2e3)
            })
        },
        write: function(t, e) {
            t.open(),
            t.write(d.docType() + "<html>" + d.getHead() + d.getBody(e) + "</html>"),
            t.close()
        },
        docType: function() {
            return c.mode == n ? "" : c.standard == e ? "<!DOCTYPE html>" : '<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01' + (c.standard == t ? " Transitional" : "") + '//EN" "http://www.w3.org/TR/html4/' + (c.standard == t ? "loose" : "strict") + '.dtd">'
        },
        getHead: function() {
            var e = ""
              , n = "";
            return c.extraHead && c.extraHead.replace(/([^,]+)/g, function(t) {
                e += t
            }),
            ...
            c.extraCss && c.extraCss.replace(/([^,\s]+)/g, function(t) {
                n += '<link type="text/css" rel="stylesheet" href="' + t + '">'
            }),
            "<head><title>" + c.popTitle + "</title>" + e + n + "</head>"
        },
        getBody: function(t) {
            var r = ""
              , i = c.retainAttr;
            return t.each(function() {
                for (var t = d.getFormData(a(this)), e = "", n = 0; n < i.length; n++) {
                    var o = a(t).attr(i[n]);
                    o && (e += (0 < e.length ? " " : "") + i[n] + "='" + o + "'")
                }
                r += "<div " + e + ">" + a(t).html() + "</div>"
            }),
            "<body>" + r + "</body>"
        },
        getFormData: function(t) {
            var e = t.clone()
              , o = a("input,select,textarea", e);
            return a("input,select,textarea", t).each(function(t) {
                ...
                var n = o.eq(t);
                "radio" == e || "checkbox" == e ? n.attr("checked", a(this).is(":checked")) : "text" == e ? n.attr("value", a(this).val()) : "select" == e ? a(this).find("option").each(function(t) {
        ...
        Popup: function() {
            ...
            t += ",width=" + c.popWd + ",height=" + c.popHt,
            t += ",resizable=yes,screenX=" + c.popX + ",screenY=" + c.popY + ",personalbar=no,scrollbars=yes";
            var e = window.open("", "_blank", t);
            return e.doc = e.document,
            e
        }
    }
}(jQuery);
