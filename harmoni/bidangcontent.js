...
<head>
	...
	<title>FOR FAPEDA | Forum Fasilitasi Peraturan Daerah</title>
	<!-- Favicon icon -->
	<!-- <link rel="icon" type="image/png" sizes="16x16" href="https://localhost/forfapeda.web.id/harmoni/assets/images/logo.png"> -->
	<!-- Custom CSS -->
	<link href="https://localhost/forfapeda.web.id/harmoni/templates/backend/css/style.min.css" rel="stylesheet">
	<link href="https://localhost/forfapeda.web.id/harmoni/templates/backend/css/custom.css" rel="stylesheet">
	<link href="https://localhost/forfapeda.web.id/harmoni/templates/backend/css/right_sidebar_menu.css" rel="stylesheet">
	...
	<![endif]-->
	<script src="https://localhost/forfapeda.web.id/harmoni/templates/backend/plugins/jquery/dist/jquery.min.js"></script>
	<script type="text/javascript" src="https://localhost/forfapeda.web.id/harmoni/assets/js/js.cookie.js"></script>
	...
	<script type="text/javascript" src="https://localhost/forfapeda.web.id/harmoni/assets/blockUI/jquery.blockUI.js"></script>
</head>
		...
		<header class="topbar">
			<nav class="navbar top-navbar navbar-expand-md navbar-dark">
				...
				<div class="navbar-header">
					<a class="navbar-brand" href="https://localhost/forfapeda.web.id/harmoni/">
						<!-- Logo icon -->
						<b>
					...
					<ul class="navbar-nav my-lg-0">
						...
						<li class="nav-item dropdown u-pro">
							...
							<div class="dropdown-menu dropdown-menu-end animated flipInY">
								...
								<a href="https://localhost/forfapeda.web.id/harmoni/pengguna/edit/admin" class="dropdown-item"><i class="ti-settings"></i> Pengaturan Akun</a>
								<div class="dropdown-divider"></div>
								<a href="https://localhost/forfapeda.web.id/harmoni/keluar" class="dropdown-item text-danger"><i class="fa fa-power-off"></i> Logout</a>
								<!-- text-->
							</div>
						</li>
						<!-- ============================================================== -->
					...
					<ul id="sidebarnav">
						<li class="user-pro"> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false">
							...
							<ul aria-expanded="false" class="collapse">
								...
								<li><a href="https://localhost/forfapeda.web.id/harmoni/keluar"><i class="fa fa-power-off text-danger"></i> Logout</a></li>
							</ul>
						</li>
						<li class="nav-small-cap">--- NAVIGATION</li>
						<li> <a class="waves-effect waves-dark" href="https://localhost/forfapeda.web.id/harmoni/dashboard" aria-expanded="false"><i class="ti-layout-grid2"></i><span class="hide-menu">Dashboard</span></a></li>
						<!-- <li> <a class="waves-effect waves-dark" href="https://localhost/forfapeda.web.id/harmoni/harmonisasi" aria-expanded="false"><i class="far fa-envelope-open"></i><span class="hide-menu">Permohonan</span></a></li> -->
						<li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="fas fa-inbox"></i><span class="hide-menu">Permohonan</span></a>
							<ul aria-expanded="false" class="collapse">
								<li><a href="https://localhost/forfapeda.web.id/harmoni/penyusunan">Penyusunan Rancangan Produk Hukum</a></li>
								<li><a href="https://localhost/forfapeda.web.id/harmoni/harmonisasi">Harmonisasi Rancangan Produk Hukum</a></li>
							</ul>
						</li>
						<li> <a class="waves-effect waves-dark" href="https://localhost/forfapeda.web.id/harmoni/perancang" aria-expanded="false"><i class="far fa-id-card"></i><span class="hide-menu">Tim Perancang</span></a></li>
						<li> <a class="waves-effect waves-dark" href="https://localhost/forfapeda.web.id/harmoni/pokja" aria-expanded="false"><i class="icon-people"></i><span class="hide-menu">Kelompok Kerja</span></a></li>
						<li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="far fa-folder-open"></i><span class="hide-menu">Data Master</span></a>
							<ul aria-expanded="false" class="collapse">
								<li><a href="https://localhost/forfapeda.web.id/harmoni/wilayah">Wilayah</a></li>
								<li><a href="https://localhost/forfapeda.web.id/harmoni/pemrakarsa">Pengusul Inisiatif</a></li>
								<li><a href="https://localhost/forfapeda.web.id/harmoni/bidang">Bidang</a></li>
								<li><a href="https://localhost/forfapeda.web.id/harmoni/kadiv">Kepala Divisi YANKUMHAM</a></li>
							</ul>
						</li>
						<!-- <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="fas fa-chart-bar"></i><span class="hide-menu">Laporan</span></a>
							<ul aria-expanded="false" class="collapse">
								<li><a href="https://localhost/forfapeda.web.id/harmoni/laporan/daftar_permohonan">Daftar Permohonan</a></li>
								<li><a href="https://localhost/forfapeda.web.idharmoni/laporan/rekap_permohonan">Rekapitulasi</a></li>
							</ul>
						</li> -->
						<li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="fas fa-chart-bar"></i><span class="hide-menu">Laporan</span></a>
							<ul aria-expanded="false" class="collapse">
								<li> <a class="has-arrow" href="javascript:void(0)" aria-expanded="false">Penyusunan Rancangan Produk Hukum</a>
									<ul aria-expanded="false" class="collapse">
										<li><a href="https://localhost/forfapeda.web.id/harmoni/laporan/daftar_penyusunan">Daftar Permohonan</a></li>
										<li><a href="https://localhost/forfapeda.web.id/harmoni/laporan/rekap_penyusunan">Rekapitulasi</a></li>
									</ul>
								</li>
								<li> <a class="has-arrow" href="javascript:void(0)" aria-expanded="false">Harmonisasi Rancangan Produk Hukum</a>
									<ul aria-expanded="false" class="collapse">
										<li><a href="https://localhost/forfapeda.web.id/harmoni/laporan/daftar_permohonan">Daftar Permohonan</a></li>
										<li><a href="https://localhost/forfapeda.web.id/harmoni/laporan/rekap_permohonan">Rekapitulasi</a></li>
									</ul>
								</li>
							</ul>
						</li>
						<!-- <li> <a class="waves-effect waves-dark" href="https://localhost/forfapeda.web.id/harmoni/perancang" aria-expanded="false"><i class="far fa-user-circle"></i><span class="hide-menu">KADIV HUMHAM</span></a></li> -->
						<li> <a class="waves-effect waves-dark" href="https://localhost/forfapeda.web.id/harmoni/keluar" aria-expanded="false"><i class="fas fa-power-off text-danger"></i><span class="hide-menu">Logout</span></a></li>
					</ul>
				</nav>
				...
				<div class="row page-titles">
					...
					<div class="col-md-7 col-4 align-self-center text-end">
						<div class="d-flex justify-content-end align-items-center">
							<!-- <ol class="breadcrumb">
								<li class="breadcrumb-item"><a href="https://localhost/forfapeda.web.id/harmoni/dashboard">Dashboard</a></li>
			...
			<div class="card-body">
				<div class="tab-content">
					<div role="tabpanel" class="tab-pane fade active show" id="table" aria-labelledby="list-tab">
						<link rel="stylesheet" type="text/css" href="https://localhost/forfapeda.web.id/harmoni/assets/sweetalert/sweetalert2.min.css" />
<!-- <link rel="stylesheet" type="text/css" href="https://localhost/forfapeda.web.id/harmoni/assets/datatable/datatables.min.css"/> -->
<link rel="stylesheet" type="text/css" href="https://localhost/forfapeda.web.id/harmoni/assets/datatable/DataTables-1.11.2/css/dataTables.bootstrap5.min.css" />
<link rel="stylesheet" type="text/css" href="https://localhost/forfapeda.web.id/harmoni/assets/datatable/Buttons-1.2.4/css/buttons.bootstrap.min.css" />
<style>
...
<script type="text/javascript" src="https://localhost/forfapeda.web.id/harmoni/assets/sweetalert/sweetalert2.min.js"></script>
<script type="text/javascript" src="https://localhost/forfapeda.web.id/harmoni/assets/datatable/datatables.min.js"></script>

<script type="text/javascript" src="https://localhost/forfapeda.web.id/harmoni/assets/datatable/pagination.select.js"></script>
<!-- <script type="text/javascript" src="https://localhost/forfapeda.web.id/harmoni/assets/datatable/Select-1.3.3/js/dataTables.select.min.js"></script> -->
<script type="text/javascript" src="https://localhost/forfapeda.web.id/harmoni/assets/datatable/Buttons-1.2.4/js/dataTables.buttons.min.js"></script>
<script type="text/javascript" src="https://localhost/forfapeda.web.id/harmoni/assets/datatable/JSZip-2.5.0/jszip.min.js"></script>
<script type="text/javascript" src="https://localhost/forfapeda.web.id/harmoni/assets/datatable/Buttons-1.2.4/js/buttons.html5.min.js"></script>
<script type="text/javascript" src="https://localhost/forfapeda.web.id/harmoni/assets/datatable/Buttons-1.2.4/js/buttons.print.min.js"></script>
...
<script>
	$(document).ready(function() {
		...
		*/
			...
			"ajax": {
				"url": "https://localhost/forfapeda.web.id/harmoni/bidang/data",
				"type": "POST",
				"data": function(d) {
	...
	function loadDetail(idData, refresh = false) {
		...
		if (idDataOld != idData || refresh) { //jika sudah ada pemanggilan dan data yang dipanggil berbeda
			...
			$('#detail').load("https://localhost/forfapeda.web.id/harmoni/bidang/detail/" + idData, function(responseTxt, statusTxt, xhr) {
...
<link href="https://localhost/forfapeda.web.id/harmoni/assets/toast-master/css/jquery.toast.css" rel="stylesheet">
<script src="https://localhost/forfapeda.web.id/harmoni/assets/toast-master/js/jquery.toast.js"></script>
<script type="text/javascript">
	...
	$('button#btnSubmit').click(function() {
		...
		if (required_input.length == 0) {
			...
			$.ajax({
				url: 'https://localhost/forfapeda.web.id/harmoni/bidang/' + $(this).attr("role"),
				type: 'post',
				dataType: 'json',
				contentType: false,
				cache: false,
	...
	function input_validation(input) {
		...
		<!-- ============================================================== -->
		<footer class="footer">
			© 2023 forfapeda.forfapedawebsite@gmail.com
		</footer>
		<!-- ============================================================== -->
		<!-- End footer -->
		<!-- ============================================================== -->
	...
	<script src="https://localhost/forfapeda.web.id/harmoni/templates/backend//js/perfect-scrollbar.jquery.min.js"></script>
	<!--Wave Effects -->
	<script src="https://localhost/forfapeda.web.id/harmoni/templates/backend//js/waves.js"></script>
	<!--Menu sidebar -->
	<script src="https://localhost/forfapeda.web.id/harmoni/templates/backend//js/sidebarmenu.js"></script>
	<!--Custom JavaScript -->
	<script src="https://localhost/forfapeda.web.id/harmoni/templates/backend//js/custom.min.js"></script>
